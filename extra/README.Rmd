...
ggplot(hall_outcome,
  ...
  # Outer bubble (larger, lighter)
  geom_point(aes(size = n_cases),
             shape = 21, fill = "white", color = "black",
             alpha = 0.5, stroke = 1.2) +
  
  # Inner bubble (actual value)
  geom_point(aes(size = n_cases, fill = hallucination),
             shape = 21, color = "black", alpha = 0.9, stroke = 0.3) +
  
  scale_size(range = c(3, 12), name = "Number of Cases") +   # <-- smaller range
